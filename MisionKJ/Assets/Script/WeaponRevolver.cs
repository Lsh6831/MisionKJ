...
public class WeaponRevolver : WeaponBase
{
    ...
    private void OnEnable()
    {
        ...
        // 무기가 활성화될 떄 해당 무기가 탄 수 정보를 갱신한다.
    ...
    public override void StartReload()
    {
        ...
        // 무기 액션 도중 'R'키를 눌러 재장전을 시도하면 무기 액션 종료후 재장전
        StopWeaponAction();
           ...
           // 사운드가 재생중이 아니고, 현재 애니메이션이 MoveMent이면
            ...
            if (audioSource.isPlaying == false && animator.CurrentAnimationIs("Movement"))
            {
                isReload = false;
                 ...
                 // 현재 탄창 수를 1 감소시키고, 바뀐 탄창 정보를 Text UI 에 업데이트
    ...
    private void TwoStepRaycast()
    {
        ...
        // 공격 사거리(attackDistance) 안에 부딪히는 오브젝트가 있다면 target
